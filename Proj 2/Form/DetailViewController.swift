...
class DetailViewcontroller: UIViewController {
    ...
    private func addConstraints() {
        ...
        firstNameSpace.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10).isActive = true
        ...
        lastNameSpace.leadingAnchor.constraint(greaterThanOrEqualTo: view.leadingAnchor, constant: 50).isActive = true
        lastNameSpace.leadingAnchor.constraint(equalTo: firstNameSpace.trailingAnchor, constant: 5).isActive = true
        lastNameSpace.trailingAnchor.constraint(lessThanOrEqualTo: view.trailingAnchor, constant: -10).isActive = true
